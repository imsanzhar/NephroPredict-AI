...
def load_ensemble_and_scaler():
    ...
    nn_path = 'ft_transformer_ckd.pth'
...
st.divider()
nn_model, rf_model, scaler = load_ensemble_and_scaler()
if nn_model is not None and rf_model is not None and scaler is not None:
